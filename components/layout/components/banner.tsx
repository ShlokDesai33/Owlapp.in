...
import { MegaphoneSimple, X } from "phosphor-react"
        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="order-3 mt-2 w-full flex-shrink-0 sm:order-2 sm:mt-0 sm:w-auto">
            <Link href="/dashboard/search" passHref>
              <button
                type="button"
                className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-indigo-600 shadow-sm hover:bg-indigo-50 w-full"
              >
                Search Now
              </button>
            </Link>
