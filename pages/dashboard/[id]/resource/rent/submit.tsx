...
const SubmitRentForm = ({ productID, booking }: { productID: string, booking: any }) => {
  ...
  useSessionStorage(productID, booking);
  ...
  return (
    <div className="pb-6">
      <h1 className="text-3xl font-bold tracking-tight text-gray-800 truncate max-w-3xl mt-6">Book {booking.productName}</h1>
      ...
      <div className="overflow-hidden bg-white rounded-sm sm:rounded-lg mt-6 border-2">
        <div className="flex justify-between items-center">
          <div className="pl-4 py-5 sm:pl-6">
            ...
            <p className="mt-1 max-w-2xl text-sm text-gray-500">Customizations specified by {booking.orgName}.</p>
          </div>
